...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar"
            style="background: #005207;">

            <!-- Sidebar - Brand -->
            <a class="ml-2 mr-2 mt-2" href="/admin">
  ...
  height: auto;">
            ...
            <li class="nav-item">
                ...
                <div id="collapse5" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/admin-foto">Foto</a>
                        <a class="collapse-item" href="/admin-video">Video</a>
                        <a class="collapse-item" href="cards.html">Tambah Album</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapse7" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/admin-profil">Profil</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
