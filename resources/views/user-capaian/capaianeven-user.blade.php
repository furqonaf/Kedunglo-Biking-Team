...
<div class="col-xl-12 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-danger">KBT Medal Browi</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
...
<div class="col-xl-12 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div
                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-danger">KBT Medal Maulud Mengkelud</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
...
<div class="col-xl-12 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div
                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-danger">KBT Medal Jomangan</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
